...
var AddonModImscpTocPage = /** @class */ (function () {
    ...
    AddonModImscpTocPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-imscp-toc',template:/*ion-inline-start:"/Users/albertolussana/Desktop/App Formazione/moodlemobiledirectory/src/addon/mod/imscp/pages/toc/toc.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ \'addon.mod_imscp.toc\' | translate }}</ion-title>\n        <ion-buttons end>\n            <button ion-button icon-only (click)="closeModal()" [attr.aria-label]="\'core.close\' | translate">\n                <ion-icon name="close"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n    <nav>\n        <ion-list>\n            <a ion-item *ngFor="let item of items" (click)="loadItem(item.href)" [class.core-bold]="!item.href" [class.core-nav-item-selected]="selected == item.href">\n                <span padding-left *ngFor="let i of getNumberForPadding(item.level)"></span>{{item.title}}\n            </a>\n        </ion-list>\n    </nav>\n</ion-content>\n'/*ion-inline-end:"/Users/albertolussana/Desktop/App Formazione/moodlemobiledirectory/src/addon/mod/imscp/pages/toc/toc.html"*/
        }),
