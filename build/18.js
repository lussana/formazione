...
var CoreSitePluginsModuleIndexPage = /** @class */ (function () {
    ...
    CoreSitePluginsModuleIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-site-plugins-module-index',template:/*ion-inline-start:"/Users/albertolussana/Desktop/App Formazione/moodlemobiledirectory/src/core/siteplugins/pages/module-index/module-index.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ title }}</ion-title>\n\n        <ion-buttons end>\n            <!-- If the site plugin defines some buttons using core-nav-buttons, they will be added here. -->\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n    <ion-refresher [enabled]="content && content.content && content.content.dataLoaded" (ionRefresh)="refreshData($event)">\n        <ion-refresher-content pullingText="{{ \'core.pulltorefresh\' | translate }}"></ion-refresher-content>\n    </ion-refresher>\n    <core-site-plugins-module-index [module]="module" [courseId]="courseId" [pageTitle]="title"></core-site-plugins-module-index>\n</ion-content>\n'/*ion-inline-end:"/Users/albertolussana/Desktop/App Formazione/moodlemobiledirectory/src/core/siteplugins/pages/module-index/module-index.html"*/,
        }),
