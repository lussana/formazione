...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__configconstants__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__classes_utils_url__ = __webpack_require__(1015);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var CoreLoginSitePage = /** @class */ (function () {
    function CoreLoginSitePage(navParams, navCtrl, fb, appProvider, sitesProvider, loginHelper, modalCtrl, domUtils, eventsProvider) {
        ...
        if (this.loginHelper.hasSeveralFixedSites()) {
            ...
            this.fixedDisplay = __WEBPACK_IMPORTED_MODULE_6__configconstants__["a" /* CoreConfigConstants */].multisitesdisplay;
        ...
        this.siteForm = fb.group({
            siteUrl: [url, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["h" /* Validators */].required]
        });
    }
    /**
    ...
    CoreLoginSitePage.prototype.connect = function (e, url) {
        ...
        if (siteData) {
            ...
            this.sitesProvider.checkSite(url)
                ...
                var domain = __WEBPACK_IMPORTED_MODULE_9__classes_utils_url__["a" /* CoreUrl */].guessMoodleDomain(url);
